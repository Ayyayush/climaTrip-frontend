...
const TravelPlan = ({ planData }) => {
  ...
  const getActivityIcon = (activity) => {
    ...
    if (activityLower.includes("flight") || activityLower.includes("airport"))
      return <Plane className="h-4 w-4" />;

    if (activityLower.includes("check-in") || activityLower.includes("hotel"))
    ...
    if (activityLower.includes("beach") || activityLower.includes("visit"))
  ...
  const getTransportIcon = (mode) => {
    ...
    if (modeLower.includes("car") || modeLower.includes("taxi"))
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">
                  {planData.transport_options.to_destination.mode}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Duration:</span>
                <span className="font-medium">
                  {planData.transport_options.to_destination.estimated_time}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Cost:</span>
                <span className="font-semibold text-green-600">
                  {planData.transport_options.to_destination.cost}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Mode:</span>
                <span className="font-medium">
                  {planData.transport_options.return.mode}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Duration:</span>
                <span className="font-medium">
                  {planData.transport_options.return.estimated_time}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Cost:</span>
                <span className="font-semibold text-green-600">
                  {planData.transport_options.return.cost}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-blue-50 rounded-lg p-4 text-center">
            ...
            <p className="text-lg font-semibold text-blue-900">
              {planData.budget_breakdown.travel}
            </p>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-4 text-center">
            ...
            <p className="text-lg font-semibold text-purple-900">
              {planData.budget_breakdown.stay}
            </p>
          </div>
          ...
          <div className="bg-orange-50 rounded-lg p-4 text-center">
            ...
            <p className="text-lg font-semibold text-orange-900">
              {planData.budget_breakdown.food}
            </p>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4 text-center">
            ...
            <p className="text-lg font-semibold text-green-900">
              {planData.budget_breakdown.activities}
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center justify-center space-x-3">
            ...
            <div>
              ...
              <p className="text-3xl font-bold">
                {planData.budget_breakdown.total}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100">
                Departure at {planData.return_plan.time} via{" "}
                {planData.return_plan.mode}
              </p>
            </div>
          </div>
